...
function Nav() {
  ...
  return (
    <div className="w-full h-[100px]  flex justify-center items-center">
      <div className="w-[100%]  bg-black flex justify-between items-center  px-5 md:px-8">
        <div className="w-[120px] h-[120px] flex justify-center items-center rounded-md shadow-xl">
